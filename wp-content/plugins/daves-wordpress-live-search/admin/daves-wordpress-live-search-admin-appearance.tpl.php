...
<tr valign="top">
<th scope="row"><?php _e( "Display Post Thumbnail", 'daves-wordpress-live-search' ); ?></th>

<td>
    <input type="hidden" name="daves-wordpress-live-search_thumbs" value="" />
    <input type="checkbox" name="daves-wordpress-live-search_thumbs" id="daves-wordpress-live-search_thumbs" value="true" <?php checked( $showThumbs ); ?> /> <label for="daves-wordpress-live-search_thumbs"><?php _e( "Display thumbnail images for every search result with at least one image", 'daves-wordpress-live-search' ); ?></label>
</td>
</tr>
...
<!-- CSS styles -->
<tr valign="top">
<td colspan="2"><h3><?php _e( "Styles", 'daves-wordpress-live-search' ); ?></h3></td>
</tr>

<tr valign="top">
<th scope="row"> </th>
<td>
<input type="radio" name="daves-wordpress-live-search_css" id="daves-wordpress-live-search_css_default_gray" value="default_gray" <?php checked( $cssOption, 'default_gray' ); ?> /> <label for="daves-wordpress-live-search_css_default_gray"><?php _e( "Default Gray", 'daves-wordpress-live-search' ); ?></label><br /><span class="setting-description"><?php _e( "Default style in gray.", 'daves-wordpress-live-search' ); ?></span>
<br /><br />
...
<br /><br />
<input type="radio" name="daves-wordpress-live-search_css" id="daves-wordpress-live-search_css_default_blue" value="default_blue" <?php checked( $cssOption, 'default_blue' ); ?> /> <label for="daves-wordpress-live-search_css_default_blue"><?php _e( "Default Blue", 'daves-wordpress-live-search' ); ?></label><br /><span class="setting-description"><?php _e( "Default style in blue", 'daves-wordpress-live-search' ); ?></span>
<br /><br />

<?php if( $color_picker_supported ) : ?>

<input type="radio" name="daves-wordpress-live-search_css" id="daves-wordpress-live-search_css_custom" value="custom" <?php checked( $cssOption, 'custom' ); ?> /> <label for="daves-wordpress-live-search_css_custom"><?php _e( "Custom", 'daves-wordpress-live-search' ); ?></label><br /><span class="setting-description"><?php _e( "Customize the search results display here", 'daves-wordpress-live-search' ); ?></span>
...
<div><label><?php _e("Width (in pixels)", 'daves-wordpress-live-search'); ?></label><input type="number" name="daves-wordpress-live-search_custom[width]" id="daves-wordpress-live-search_custom_width" value="<?php if(!empty($customOptions['width'])) echo $customOptions['width']; else echo "250" ?>" /></div>

<div><label><?php _e("Title", 'daves-wordpress-live-search'); ?></label><input type="text" name="daves-wordpress-live-search_custom[title]" id="daves-wordpress-live-search_custom_title" value="<?php if(!empty($customOptions['title'])) echo $customOptions['title']; ?>" data-default-color="#000" class="dwls_color_picker" pattern="^#[0-9,a-f]{3,6}" /></div>

<div><label><?php _e("Excerpt", 'daves-wordpress-live-search'); ?></label><input type="text" name="daves-wordpress-live-search_custom[fg]" id="daves-wordpress-live-search_custom_fg" value="<?php if(!empty($customOptions['fg'])) echo $customOptions['fg']; ?>" data-default-color="#000" class="dwls_color_picker" pattern="^#[0-9,a-f]{3,6}" /></div>

<div><label><?php _e("Background", 'daves-wordpress-live-search'); ?></label><input type="text" name="daves-wordpress-live-search_custom[bg]" id="daves-wordpress-live-search_custom_bg" value="<?php if(!empty($customOptions['bg'])) echo $customOptions['bg']; ?>" data-default-color="#ddd" class="dwls_color_picker" pattern="^#[0-9,a-f]{3,6}" /></div>

<div><label><?php _e("Hover Background", 'daves-wordpress-live-search'); ?></label><input type="text" name="daves-wordpress-live-search_custom[hoverbg]" id="daves-wordpress-live-search_custom_hoverbg" value="<?php if(!empty($customOptions['hoverbg'])) echo $customOptions['hoverbg']; ?>" data-default-color="#fff" class="dwls_color_picker" pattern="^#[0-9,a-f]{3,6}" /></div>

<div><label><?php _e("Divider", 'daves-wordpress-live-search'); ?></label><input type="text" name="daves-wordpress-live-search_custom[divider]" id="daves-wordpress-live-search_custom_divider" value="<?php if(!empty($customOptions['divider'])) echo $customOptions['divider']; ?>" data-default-color="#aaa" class="dwls_color_picker" pattern="^#[0-9,a-f]{3,6}" /></div>

<div><label><?php _e("Footer Background", 'daves-wordpress-live-search'); ?></label><input type="text" name="daves-wordpress-live-search_custom[footbg]" id="daves-wordpress-live-search_custom_footbg" value="<?php if(!empty($customOptions['footbg'])) echo $customOptions['footbg']; ?>" data-default-color="#888" class="dwls_color_picker" pattern="^#[0-9,a-f]{3,6}" /></div>

<div><label><?php _e("Footer Text", 'daves-wordpress-live-search'); ?></label><input type="text" name="daves-wordpress-live-search_custom[footfg]" id="daves-wordpress-live-search_custom_footfg" value="<?php if(!empty($customOptions['footfg'])) echo $customOptions['footfg']; ?>" data-default-color="#fff" class="dwls_color_picker" pattern="^#[0-9,a-f]{3,6}" /></div>

<div><label><?php _e("Shadow", 'daves-wordpress-live-search'); ?></label><input type="checkbox" name="daves-wordpress-live-search_custom[shadow]" id="daves-wordpress-live-search_custom_shadow" value="true" class="dwls_design_toggle" <?php checked(!empty($customOptions['shadow'])); ?> /></div>
...
<input type="radio" name="daves-wordpress-live-search_css" id="daves-wordpress-live-search_css_theme" value="theme" <?php checked($cssOption, 'theme'); ?> /> <label for="daves-wordpress-live-search_css_theme"><?php _e("Theme-specific", 'daves-wordpress-live-search'); ?></label><br /><span class="setting-description"><strong><?php _e("For advanced users", 'daves-wordpress-live-search'); ?>:</strong> <?php _e("Theme must include a CSS file named daves-wordpress-live-search.css. If your theme does not have one, copy daves-wordpress-live-search_default_gray.css from this plugin's directory into your theme's directory and modify as desired.", 'daves-wordpress-live-search'); ?></span>
<br /><br />
<input type="radio" name="daves-wordpress-live-search_css" id="daves-wordpress-live-search_css_existing_theme" value="notheme" <?php checked($cssOption, 'notheme'); ?> /> <label for="daves-wordpress-live-search_css_theme"><?php _e("Theme-specific (theme's own CSS file)", 'daves-wordpress-live-search'); ?></label><br /><span class="setting-description"><strong><?php _e("For advanced users", 'daves-wordpress-live-search'); ?>:</strong> <?php _e("Use the styles contained within your Theme's stylesheet. Don't include a separate stylesheet for Live Search.", 'daves-wordpress-live-search'); ?>
</td>
</tr>
